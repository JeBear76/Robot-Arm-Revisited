...
void setSleep() {
  currentShoulderTilt =
      changePulse(SHOULDER_TILT, currentShoulderTilt, SHOULDER_TILT_MAX);
  ...
  currentShoulderTilt =
      changePulse(SHOULDER_TILT, currentShoulderTilt, SHOULDER_TILT_SLEEP);
  currentWristTilt =
      changePulse(WRIST_TILT, currentWristTilt, WRIST_TILT_SLEEP);
}
...
void setAwake() {
  ...
  currentShoulderTilt =
      changePulse(SHOULDER_TILT, SHOULDER_TILT_SLEEP, SHOULDER_TILT_INIT);
  ...
  if (Serial.available()) {
    ...
    switch (reqAction) {
      ...
      case 120:  // x
      {
        ...
        reqEndPulse =
            validateReqEndPulse(reqEndPulse, WRIST_TILT_MIN, WRIST_TILT_MAX);
        currentWristTilt =
            changePulse(WRIST_TILT, currentWristTilt, reqEndPulse);
        break;
      }
      case 69:   // E
      case 101:  // e
      ...
      case 116:  // t
      {
        ...
        reqEndPulse = validateReqEndPulse(reqEndPulse, SHOULDER_TILT_MIN,
                                          SHOULDER_TILT_MAX);
        currentShoulderTilt =
            changePulse(SHOULDER_TILT, currentShoulderTilt, reqEndPulse);
        break;
      }
      case 83:   // S
      case 115:  // s
      {
        ...
        reqEndPulse =
            validateReqEndPulse(reqEndPulse, SHOULDER_MIN, SHOULDER_MAX);
